...
export function checkIdentity(output: string): IdentityCheck {
  return {
    ...
    hasWebArchitecture: output.includes('spiderweb') || output.includes('SpiderWeb')
  };
}
`
    };
...
export function generateFirewallTests(): FirewallTest[] {
  return [
    ...
    },
    {
      ...
      code: 'function doWork() { return { success: true }; }',
      shouldBlock: true,
      blocked: null,
      finding: null
    }
