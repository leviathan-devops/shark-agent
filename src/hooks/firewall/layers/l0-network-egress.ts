...
export const L0_NETWORK_EGRESS: LayerRule = {
  layer: 'L5.13',
  analysisOrder: 1,
  ...
  correction: 'Network egress is forbidden. All operations run in isolated sandbox without external network access. Use TUI container via tmux + docker exec -it for any browser or network testing. Run shark-spawn-container first, then use docker exec -it <container> for TUI operations.',
  enabled: true,
};
