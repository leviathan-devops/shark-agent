...
export const L0_TEST_BYPASS: LayerRule = {
  layer: 'L2',
  analysisOrder: 1,
  ...
  correction: "Tests must run via container TUI with hooks. Use: shark-test-runner action=run — do NOT use npm test/jest/pytest which bypass hooks",
  enabled: true,
};
