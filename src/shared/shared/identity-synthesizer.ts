...
export interface T1Warheads {
  /** Identity binding -- "SHARK v4.9.9 -- runtime-grade software engineering agent with planning brain" (~200B) */
...
function buildIdentityWarhead(t2: Record<string, string>): string {
  ...
  const whoLine = whoMatch
    ? whoMatch[0].trim()
    : 'SHARK v4.9.9 -- runtime-grade software engineering agent with planning brain';
  ...
  let responseLine = 'whoami: "I am SHARK v4.9.9, a runtime-grade software engineering agent with planning brain."';
