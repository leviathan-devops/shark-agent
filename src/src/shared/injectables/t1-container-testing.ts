...
export const CT06_ANTIDERAIL_SKIP_CONTAINER_TEST: ViolationDetector = {
  ...
  fix: 'Remove all skip/bypass paths for container testing. §25 Anti-Derailment Fractal Rule: any proposal to skip container testing must be blocked with reference to this bible. There is no alternate method — only the 12-Step Container Protocol.',
};
